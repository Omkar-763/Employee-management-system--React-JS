...
const Sidebar = () => {
    ...
    return (
        <div>
            <nav 
                className="sidebar fixed min-h-screen w-[260px] shadow-lg z-50 transition-all duration-300 
                ...
                <div className="h-full">
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)]">
                        <ul className="p-4">
                            ...
                            {/* Todo List - Visible for all users */}
                            <li className="nav-item">
                                <NavLink to="/apps/todolist" className="group">
                                    <div className="flex items-center">
                                        <IconMenuTodo className="shrink-0" />
                                        <span className="pl-3 text-black dark:text-white">{t('Todo List')}</span>
                                    </div>
                                </NavLink>
                            </li>

                            {/* Scrumboard - Visible for all users */}
                            <li className="nav-item">
                                <NavLink to="/apps/scrumboard" className="group">
                                    <div className="flex items-center">
