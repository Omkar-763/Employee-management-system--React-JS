...
const fetchApprovals = async () => {
  ...
  return (
    <div className="flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full">
      ...
      {/* Main content area */}
      <div className={`overlay bg-black/60 z-[5] w-full h-full rounded-md absolute hidden ${isShowApprovalMenu && '!block xl:!hidden'}`} onClick={() => setIsShowApprovalMenu(!isShowApprovalMenu)}></div>
        ...
        <div className="flex flex-col h-full">
              ...
              <div className="p-4">
                <div className="mb-5">
                  <div className="flex border-b border-white-light dark:border-[#1b2e4b]">
                    ...
                    <button
                      type="button"
                      className={`py-2 px-4 border-b border-transparent hover:border-primary hover:text-primary ${activeForm === 'attendanceIssue' ? '!border-primary text-primary' : ''}`}
                    ...
                    <button
                      type="button"
                      className={`py-2 px-4 border-b border-transparent hover:border-primary hover:text-primary ${activeForm === 'breakIssue' ? '!border-primary text-primary' : ''}`}
          ...
          <div className="p-4">
            <h3 className="text-lg font-semibold mb-4">
              {isAdmin ? 'Approval Requests' : 'My Approval History'}
            </h3>
            {error && (
