...
const Profile = () => {
  ...
  const [userInfo, setUserInfo] = useState({
    name: '',
    email: '',
    profileImage: '/assets/images/profile-34.jpeg', // Default profile picture
    jobTitle: 'Web Developer', // Default job title
    dob: 'Jan 20, 1989', // Default date of birth
    location: 'New York, USA', // Default location
    phone: '+1 (530) 555-12121', // Default phone number
  });
      ...
      try {
        ...
        if (token) {
          ...
          setUserInfo((prevState) => ({
            ...prevState, // Keep existing fields
            name,
            email,
          }));
        } else {
        ...
        console.error('Failed to fetch user info:', error); // Debug log
      }
    };
  ...
  return (
    <div>
      <ul className="flex space-x-2 rtl:space-x-reverse">
        <li>
          <span className="text-primary hover:underline">Users</span>
        </li>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-5">
          <div className="panel">
            <div className="flex items-center justify-between mb-5">
              ...
              <button className="ltr:ml-auto rtl:mr-auto btn btn-primary p-2 rounded-full">
                <IconPencilPaper />
              </button>
            </div>
            <div className="mb-5">
              <div className="flex flex-col justify-center items-center">
                <img
                  src={userInfo.profileImage} // Dynamic profile picture
                  alt="Profile"
              ...
              <ul className="mt-5 flex flex-col max-w-[160px] m-auto space-y-4 font-semibold text-white-dark">
                <li className="flex items-center gap-2">
                  ...
                  {userInfo.jobTitle} {/* Dynamic job title */}
                </li>
                <li className="flex items-center gap-2">
                  <IconCalendar className="shrink-0" />
                  {userInfo.dob} {/* Dynamic date of birth */}
                </li>
                <li className="flex items-center gap-2">
                  <IconMapPin className="shrink-0" />
                  {userInfo.location} {/* Dynamic location */}
                </li>
                <li>
                  <button className="flex items-center gap-2">
                    <IconMail className="w-5 h-5 shrink-0" />
                    <span className="text-primary truncate">{userInfo.email}</span> {/* Dynamic email */}
                  </button>
                </li>
                <li className="flex items-center gap-2">
                  <IconPhone />
                  <span className="whitespace-nowrap" dir="ltr">
                    {userInfo.phone} {/* Dynamic phone number */}
                  </span>
                </li>
              </ul>
